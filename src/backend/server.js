...
import documentoPersonaRoutes from './routes/DocumentoPersona.js'
/**
...
// Rutas de Documentos (contratos pero se puede usar para mas)
app.use('/api', documentoPersonaRoutes);
