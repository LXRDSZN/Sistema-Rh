  ...
  <div class="sidebar">
    <div class="sidebar-content" :class="{ 'is-open': isSidebarOpen }">
      ...
      <div class="menu-row logo-row desplegar " @click="toggleSidebar"
        :aria-label="isSidebarOpen ? 'Cerrar menú' : 'Abrir menú'" tabindex="0" title="Recursos Humanos">
      ...
      <div class="menu-row" :class="{ active: isActive('/Asistencias') || isAsistenciasMenuOpen }"
        ...
        <div class="menu-link">
          ...
          <span v-if="isSidebarOpen" class="material-symbols-rounded dropdown-icon"
            :class="{ rotated: isAsistenciasMenuOpen }">
            expand_more
          </span>
        </div>
      </div>
      ...
      <div class="menu-row" :class="{ active: isActive('/Contratos') || isContratosMenuOpen }"
        ...
        <div class="menu-link">
          ...
          <span v-if="isSidebarOpen" class="material-symbols-rounded dropdown-icon"
            :class="{ rotated: isContratosMenuOpen }">
            expand_more
          </span>
        </div>
      </div>
      ...
      <div class="menu-row" :class="{ active: isActive('/Vacaciones') || isVacacionesMenuOpen }"
        ...
        <div class="menu-link">
          ...
          <span v-if="isSidebarOpen" class="material-symbols-rounded dropdown-icon"
            :class="{ rotated: isVacacionesMenuOpen }">
            expand_more
          </span>
        </div>
      </div>
