    ...
    <div class="sidebar-content" :class="{ 'is-open': isOpen }">
      ...
      >
        <div class="menu-link">
          ...
          <span v-if="isOpen" class="material-symbols-rounded dropdown-icon" :class="{ rotated: isAsistenciasMenuOpen }">
            expand_more
          </span>
        </div>
      </div>
      ...
      <transition name="dropdown">
        <div v-if="isAsistenciasMenuOpen && isOpen" class="submenu-dropdown">
          <RouterLink to="/Asistencias" class="dropdown-item" @click.stop="closeAsistenciasMenu">
            <span>Vistas Para Asistencias</span>
          </RouterLink>
